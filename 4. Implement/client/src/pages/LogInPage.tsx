    ...
    return (
        <div className="login flex justify-center items-center h-screen bg-login">
            <div className="flex login w-login h-4/5 bg-white relative rounded-3xl">
                ...
                <div className={`img transition-all duration-400 ease-in-out ${isActive ? 'left-0 rounded-s-3xl':'left-1/2 rounded-e-3xl'} w-1/2 h-full bg-imgLogin flex justify-center items-center absolute`}>
